#ifndef MIL_CLASSIFIER_MATLAB_HEADER
#define MIL_CLASSIFIER_MATLAB_HEADER
/* ==========================================================================
 * classifier.h
 * parameter0  pathces
 * parameter1  alpha
                ...
                )
{
    ...
    for(int iselector = 0; iselector < numofselectors; ++ iselector) {
        ...
        pos_sigma[iselector] = haarfeature[iselector][POSGAUSSIAN].data[selectorInt[iselector] + featureNumInEachSelector];
        
        neg_mean[iselector] = haarfeature[iselector][NEGGAUSSIAN].data[selectorInt[iselector]];
        neg_sigma[iselector] = haarfeature[iselector][NEGGAUSSIAN].data[selectorInt[iselector] + featureNumInEachSelector];
        #ifdef _DEBUG_
