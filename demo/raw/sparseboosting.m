function [objectlocation, confidence, t_selectors, strongclassifier, selectors, alpha] = sparseboosting(strongclassifier, sumimagedata, patches)
    ...
    for  i = 1:50
        ...
        labelforupdate(8) = -1;
        [strongclassifier, selectors, alpha] = updatesparse(strongclassifier, sumimagedata, patchesforupdate, labelforupdate, importance);
